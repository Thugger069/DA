...
rm -f php.ini;
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/php.ini;
chmod 644 php.ini;
# PHP56
...
date;
wget https://raw.githubusercontent.com/minhvinhdao/DA/main/add-domain.txt -P /var/www/html/ && chmod 644 /var/www/html/add-domain.txt;
# DirectAdmin Config
